...
public final class MagikSonarWayProfile implements BuiltInQualityProfilesDefinition {
    ...
    public void define(final Context context) {
        final NewBuiltInQualityProfile profile = context.createBuiltInQualityProfile(PROFILE_NAME, Magik.KEY);
        BuiltInQualityProfileJsonLoader.load(profile, CheckList.REPOSITORY_KEY, MagikSonarWayProfile.PROFILE_LOCATION);
        profile.done();
    }

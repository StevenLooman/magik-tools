...
/** module.def highlighter visitor. */
public class ModuleDefHighlighterVisitor extends ModuleDefVisitor {

  private static final List<String> KEYWORDS = List.of(ModuleDefinitionKeyword.keywordValues());

  private final NewHighlighting newHighlighting;

  public ModuleDefHighlighterVisitor(final SensorContext context, final InputFile inputFile) {
  ...
  public void walkToken(final Token token) {
    ...
    if (ModuleDefHighlighterVisitor.KEYWORDS.contains(lowerTokenValue)) {

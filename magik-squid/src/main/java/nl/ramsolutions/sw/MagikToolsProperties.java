...
public class MagikToolsProperties {
    ...
    public MagikToolsProperties() throws IOException {
        this(MagikToolsProperties.class.getClassLoader().getResourceAsStream(DEFAULT_PROPERTIES_FILENAME));
    ...
    /**
     * Get a property value as a list. Items are separated by {@link MagikToolsProperties.LIST_SEPARATOR}.

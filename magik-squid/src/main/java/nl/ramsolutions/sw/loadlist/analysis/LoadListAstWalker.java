...
public abstract class LoadListAstWalker {
  ...
  public void walkAst(final AstNode node) {
    ...
    switch (value) {
      ...
      case BLANK_LINE:
        this.walkPreBlankLine(node);
        this.walkChildren(node);
        this.walkPostBlankLine(node);
        break;
  ...
  protected void walkPreBlankLine(final AstNode node) {
    this.walkPreDefault(node);
  }

  protected void walkPostBlankLine(final AstNode node) {
    this.walkPostDefault(node);
  }

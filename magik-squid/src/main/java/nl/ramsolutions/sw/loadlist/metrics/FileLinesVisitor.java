 ...
 */
public class FileLinesVisitor extends LoadListVisitor {

  private final boolean ignoreHeaderComments;
  private boolean seenFirstToken;

  private final Set<Integer> linesOfEntry = new HashSet<>();
  ...
  public Set<Integer> getLinesOfEntry() {
    return Collections.unmodifiableSet(this.linesOfEntry);
  }

...
# generate preamble
print("""package nl.ramsolutions.sw.FIXME;

import com.sonar.sslr.api.AstNode;
import com.sonar.sslr.api.AstNodeType;
import com.sonar.sslr.api.Token;
import com.sonar.sslr.api.Trivia;
import nl.ramsolutions.sw.FIXME.api.FIXMEGrammar;
 ...
 */
public abstract class FIXMEAstWalker {
    ...
    public void walkAst(final AstNode node) {
        ...
        if (!(nodeType instanceof FIXMEGrammar value)) {

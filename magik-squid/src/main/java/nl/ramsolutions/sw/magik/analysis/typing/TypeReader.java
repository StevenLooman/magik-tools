...
/**
 * Type reader. Interprets {@link TypeString}/{@link ExpressionResultString}, and returns a {@link
 * AbstractType}/{@link ExpressionResult}, respectively.
 */
public final class TypeReader {
  ...
  /**
   * Parse a type string and return the type. The result can be a {@link CombinedType} type when
   * types are combined with a {@code |}-sign.
   *
   ...
   */
  public static ExpressionResultString unparseExpressionResult(

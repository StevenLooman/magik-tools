...
public final class TypeStringParser {
   ...
   * @return Parsed {@link TypeString}.
   */
  public static TypeString parseTypeString(
      final @Nullable String typeStr, final String currentPakkage) {
    if (typeStr == null) {
  ...
  public static ExpressionResultString parseExpressionResultString(
      final @Nullable String expressionResultStr, final String currentPakkage) {
  ...
  private static TypeString typeStringNodeToTypeString(
      final AstNode node, final String currentPakkage) {

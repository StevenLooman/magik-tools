...
public class FileLinesVisitor extends MagikVisitor {
    ...
    private static final Set<AstNodeType> NON_EXECUTABLE_TOKENS = Set.of(
    ...
    private void visitComment(final Trivia trivia) {
        final String originalValue = FileLinesVisitor.getCommentContent(trivia.getToken().getOriginalValue());
        ...
        for (final String commentLine : commentLines) {
            if (commentLine.contains("NOSONAR")) {
                ...
                this.nosonarLines.add(line);
                       ...
                       && !this.nosonarLines.contains(line)) {

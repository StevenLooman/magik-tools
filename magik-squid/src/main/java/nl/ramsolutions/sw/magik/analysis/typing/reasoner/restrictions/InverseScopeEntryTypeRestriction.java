...
public class InverseScopeEntryTypeRestriction implements TypeRestriction {
    ...
    public TypeRestriction not() {
        return new ScopeEntryTypeRestriction(this.scopeEntry, this.unrestrictedType, this.restrictedType);
    }
    ...
    public Map.Entry<ScopeEntry, AbstractType> getRestriction() {
        final AbstractType differenceType = AbstractType.difference(this.unrestrictedType, this.restrictedType);

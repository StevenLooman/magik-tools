...
public class ProcedureInstance extends AbstractType {
  ...
  private static final Map<Modifier, Method.Modifier> METHOD_MODIFIER_MAPPING =
      Map.of(Modifier.ITER, Method.Modifier.ITER);
  ...
  public ProcedureInstance( // NOSONAR
    ...
    this.procedureName = procedureName != null ? procedureName : ANONYMOUS_PROCEDURE;
    final EnumSet<Method.Modifier> methodModifiers =
        modifiers.stream()

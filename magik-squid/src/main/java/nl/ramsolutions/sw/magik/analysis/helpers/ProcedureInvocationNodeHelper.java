...
public class ProcedureInvocationNodeHelper {
  ...
  /**
   * Check if node is a PROCEDURE_INVOCATION node with name. Not that this does not handle any type
   * resolution, so this is primarily used for: - def_package - def_slotted_exemplar - ...
   *

...
public class ScopeEntryTypeRestriction implements TypeRestriction {
    ...
    public TypeRestriction not() {
        return new InverseScopeEntryTypeRestriction(this.scopeEntry, this.unrestrictedType, this.restrictedType);
    }
    ...
    public Map.Entry<ScopeEntry, AbstractType> getRestriction() {
        ...
        final AbstractType intersectionType = AbstractType.intersection(this.unrestrictedType, this.restrictedType);

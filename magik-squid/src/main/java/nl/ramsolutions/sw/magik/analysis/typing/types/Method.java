...
public class Method {
  ...
  public static class GlobalUsage {
    ...
    public String toString() {
      return String.format(
          "%s@%s(%s)",
          this.getClass().getName(), Integer.toHexString(this.hashCode()), this.getGlobal());
    }
  }
  ...
  public static class MethodUsage {
     ...
     */
    public MethodUsage(
        final TypeString typeRef, final String methodName, final @Nullable Location location) {
  ...
  public Method( // NOSONAR
    ...
    this.location = location;
    this.modifiers =
        !modifiers.isEmpty() ? EnumSet.copyOf(modifiers) : EnumSet.noneOf(Modifier.class);
    this.owner = owner;
    this.name = name;

...
/**
 * Helper for LEAVE_STATEMENT nodes.
 */
public class LeaveStatementNodeHelper {
     ...
     */
    public LeaveStatementNodeHelper(final AstNode node) {
        if (!node.is(MagikGrammar.LEAVE_STATEMENT)) {

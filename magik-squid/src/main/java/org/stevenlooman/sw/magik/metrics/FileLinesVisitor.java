...
public class FileLinesVisitor extends MagikVisitor {
  ...
  private static final Set<AstNodeType> NON_EXECUTABLE_TOKENS = Sets.newHashSet(
      MagikKeyword.HANDLING,
      MagikKeyword.BLOCK,
      MagikKeyword.TRY, MagikKeyword.WHEN, MagikKeyword.ENDTRY,
      MagikKeyword.PROTECT, MagikKeyword.PROTECTION, MagikKeyword.ENDPROTECT,
      MagikKeyword.LOCK, MagikKeyword.ENDLOCK,
      MagikKeyword.CATCH, MagikKeyword.ENDCATCH,
      MagikKeyword.PROC, MagikKeyword.ENDPROC,

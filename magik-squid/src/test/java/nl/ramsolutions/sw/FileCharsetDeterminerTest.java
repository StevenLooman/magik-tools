...
class FileCharsetDeterminerTest {
    ...
    void testParseIso88591() {
        final Path path = this.getPath(Path.of("src/test/resources/tests/parser/determine_encoding_1.magik"));
    ...
    @Test
    void testParseUtf8() {
        final Path path = this.getPath(Path.of("src/test/resources/tests/parser/determine_encoding_2.magik"));
        final Charset result = FileCharsetDeterminer.determineCharset(path);

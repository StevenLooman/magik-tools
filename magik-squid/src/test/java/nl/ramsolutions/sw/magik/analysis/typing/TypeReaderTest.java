...
class TypeReaderTest {
  ...
  private ExpressionResult parseExpressionResultString(
  ...
  void testParameterReference() {
    ...
    assertThat(parameterType.getTypeString()).isEqualTo(TypeString.ofParameterRef("param1"));
  }
  ...
  void testParseGeneric() {
    ...
    assertThat(parsedMagikType.getTypeString())
        .isEqualTo(
            TypeString.ofIdentifier(
                "rope", "sw", TypeString.ofGenericDefinition("E", TypeString.SW_INTEGER)));
  }

...
class LocalTypeReasonerTest {
    ...
    void testReasonMethodMultiReturnDifferent() {
        ...
        final AbstractType combinedType = CombinedType.combine(
    ...
    void testLoopResultOptional() {
        ...
        final AbstractType expectedType = CombinedType.combine(
            typeKeeper.getType(TypeString.SW_INTEGER),
    ...
    void testMergeReturnTypes() {
        ...
        final AbstractType intAndUndefinedType = CombinedType.combine(
            typeKeeper.getType(TypeString.SW_INTEGER),
        ...
        final AbstractType unsetAndUndefinedType = CombinedType.combine(
            typeKeeper.getType(TypeString.SW_UNSET),
            UndefinedType.INSTANCE);

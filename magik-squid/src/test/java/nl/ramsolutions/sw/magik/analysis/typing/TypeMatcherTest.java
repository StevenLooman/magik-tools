...
class TypeMatcherTest {
    ...
    void testTypeEquals() {
        ...
        final AbstractType type = new MagikType(typeKeeper, null, Sort.INTRINSIC, typeRef);
    ...
    void testTypeNotEquals() {
        ...
        final AbstractType type = new MagikType(typeKeeper, null, Sort.INTRINSIC, type1Ref);
        final AbstractType criterium = new MagikType(typeKeeper, null, Sort.INTRINSIC, type2Ref);
    ...
    void testTypeIsKindOf() {
        ...
        final MagikType baseType = new MagikType(typeKeeper, null, Sort.INTRINSIC, baseRef);
        final TypeString childRef = TypeString.ofIdentifier("child", "sw");
        final MagikType childType = new MagikType(typeKeeper, null, Sort.INTRINSIC, childRef);
    ...
    void testTypeMatchesCombinedType() {
        final TypeKeeper typeKeeper = new TypeKeeper();
        final TypeString type1Ref = TypeString.ofIdentifier("type1", "sw");
        final MagikType type1 = new MagikType(typeKeeper, null, Sort.INTRINSIC, type1Ref);
        final TypeString type2Ref = TypeString.ofIdentifier("type2", "sw");
        final MagikType type2 = new MagikType(typeKeeper, null, Sort.INTRINSIC, type2Ref);
    ...
    void testTypeNotMatchesCombinedType() {
        ...
        final AbstractType type3 = new MagikType(typeKeeper, null, Sort.INTRINSIC, type3Ref);
        final TypeString type1Ref = TypeString.ofIdentifier("type1", "sw");
        final MagikType type1 = new MagikType(typeKeeper, null, Sort.INTRINSIC, type1Ref);
        final TypeString type2Ref = TypeString.ofIdentifier("type2", "sw");
        final MagikType type2 = new MagikType(typeKeeper, null, Sort.INTRINSIC, type2Ref);
    ...
    void testCombinedTypeMatchesCombinedType() {
        ...
        final TypeString type3Ref = TypeString.ofIdentifier("type3", "sw");
        final MagikType type3 = new MagikType(typeKeeper, null, Sort.INTRINSIC, type3Ref);
    ...
    void testIsKindOfDirectParent() {
        ...
        final MagikType childType = new MagikType(typeKeeper, null, Sort.INTRINSIC, childRef);
        childType.addParent(baseRef);
        final AbstractType criterium = new MagikType(typeKeeper, null, Sort.INTRINSIC, baseRef);
    ...
    void testIsKindOfIndirectParent() {
        final TypeKeeper typeKeeper = new TypeKeeper();
        final TypeString baseRef = TypeString.ofIdentifier("base", "sw");
        final AbstractType baseType = new MagikType(typeKeeper, null, Sort.INTRINSIC, baseRef);
        final TypeString child1Ref = TypeString.ofIdentifier("child1", "sw");
        final MagikType child1Type = new MagikType(typeKeeper, null, Sort.INTRINSIC, child1Ref);
        child1Type.addParent(baseRef);
        final TypeString child2Ref = TypeString.ofIdentifier("child2", "sw");
        final MagikType child2Type = new MagikType(typeKeeper, null, Sort.INTRINSIC, child2Ref);

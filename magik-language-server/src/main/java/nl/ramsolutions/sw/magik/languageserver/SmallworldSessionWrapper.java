...
/**
 * Terminal wrapper for Smallworld session. Allows you to start and stop a session. Interfaces with
 * the Smallworld session via its terminal. Provides useful shortcuts like alt-p and alt-n, for
 * previous and next command, respectively.
 */
...
public class SmallworldSessionWrapper {
  ...
  public static void main(String[] args) throws IOException {
    ...
    ISmallworldSessionWrapperHandler handler =

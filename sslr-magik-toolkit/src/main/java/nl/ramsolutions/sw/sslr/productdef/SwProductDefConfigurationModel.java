package nl.ramsolutions.sw.sslr.productdef;
...
/** Product definition configuration model. */
public final class SwProductDefConfigurationModel implements ConfigurationModel {
  ...
  public Parser<LexerlessGrammar> getParser() {
    ...
    return new ParserAdapter<>(charset, ProductDefinitionGrammar.create());
  }
  ...
  public List<Tokenizer> getTokenizers() {
    return List.of(
        ...
        new KeywordsTokenizer(
            "<span class=\"k\">", "</span>", ProductDefinitionKeyword.keywordValues())); // NOSONAR
  }
}

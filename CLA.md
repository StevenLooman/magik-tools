...
You hereby irrevocably assign to the Owner all right, title, and interest worldwide in and to each Contribution, including without limitation:

- **(a)** All copyrights, including the right to reproduce, prepare derivative works, distribute, publicly perform, and publicly display the Contribution;
- **(b)** All patent rights, including the right to make, have made, use, sell, offer for sale, and import the Contribution and any inventions or processes described therein;
- **(c)** All other intellectual property rights, including trade secrets, trademarks, and any other proprietary rights relating to the Contribution.

This assignment is effective upon each act of submission, without further action required by either party.
...
EXCEPT FOR THE EXPRESS WARRANTIES IN SECTION 5, CONTRIBUTIONS ARE PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.

### 7. Consequential Damage Waiver

IN NO EVENT SHALL EITHER PARTY BE LIABLE TO THE OTHER FOR ANY INCIDENTAL, SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES (INCLUDING LOST PROFITS) ARISING OUT OF OR RELATING TO THIS AGREEMENT, HOWEVER CAUSED.
...
This Agreement constitutes the entire agreement between you and the Owner concerning Contributions to the Project and supersedes all prior agreements or communications regarding the subject matter hereof.

### 11. Acceptance

You signify your acceptance of this Agreement by adding your name and GitHub username to the [CLA-SIGNERS](CLA-SIGNERS) file in a pull request to this repository.

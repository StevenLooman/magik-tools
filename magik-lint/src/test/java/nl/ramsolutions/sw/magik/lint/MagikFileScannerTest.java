...
class MagikFileScannerTest {
    ...
    void testScanFiles() throws IOException {
        ...
        assertThat(actualPathsCollection).containsExactlyInAnyOrder(
            ...
            this.getPath("magik-lint/src/test/resources/test_product/test_module/source/sw/integer.magik"));
    }

    @Test
    void testgetFilesFromArgsSingleFile() throws IOException {
        final Path path = this.getPath("magik-lint/src/test/resources/test_product/test_module/source/a.magik");

...
/** Tests {@link PragmaDoesNotIncludeModuleNameInTopicsCheck}. */
public class PragmaDoesNotIncludeModuleNameInTopicsCheckTest {

  @Test
  void testValid() throws IOException {
    final MagikCheck check = new PragmaDoesNotIncludeModuleNameInTopicsCheck();
    final Path path =
        Path.of(

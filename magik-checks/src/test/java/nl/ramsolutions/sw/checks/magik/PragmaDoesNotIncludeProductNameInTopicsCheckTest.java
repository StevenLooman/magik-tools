...
/** Tests {@link PragmaDoesNotIncludeProductNameInTopicsCheck}. */
public class PragmaDoesNotIncludeProductNameInTopicsCheckTest {

  @Test
  void testValid() throws IOException {
    final MagikCheck check = new PragmaDoesNotIncludeProductNameInTopicsCheck();
    final Path path =
        Path.of(

...
/** Tests {@link PragmaTopicsDoesNotIncludeModuleNameCheck}. */
public class PragmaTopicsDoesNotIncludeModuleNameCheckTest {

  @Test
  void testValid() throws IOException {
    final MagikCheck check = new PragmaTopicsDoesNotIncludeModuleNameCheck();
    final Path path =
        Path.of(

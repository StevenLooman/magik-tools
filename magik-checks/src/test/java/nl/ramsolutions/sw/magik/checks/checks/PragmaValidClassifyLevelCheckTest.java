...
/** Tests {@link PragmaValidClassifyLevelCheck}. */
public class PragmaValidClassifyLevelCheckTest extends MagikCheckTestBase {
  ...
  void testValid(final String code) {
    final MagikCheck check = new PragmaValidClassifyLevelCheck();

...
public interface ISlapProtocol {
   ...
   * @throws IOException -
   */
  CompletableFuture<ISlapResponse> step(long threadId, StepType stepType, int count)
      throws IOException;
   ...
   * @throws IOException -
   */
  CompletableFuture<ISlapResponse> evaluate(long threadId, int level, String expression)
      throws IOException;

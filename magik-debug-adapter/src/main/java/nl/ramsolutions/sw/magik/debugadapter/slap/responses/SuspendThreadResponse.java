...
/**
 * Suspend thread response.
 */
@SuppressWarnings("JavadocVariable")
public class SuspendThreadResponse implements ISlapResponse {
    ...
    public RequestType getRequestType() {
        return RequestType.SUSPEND_THREAD;
    }
    ...
    public static SuspendThreadResponse decode(final ByteBuffer buffer) {
        return new SuspendThreadResponse();
    }

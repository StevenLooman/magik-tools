...
class ThreadManager {
    ...
    private void step(final long threadId, final StepType stepType)
        ...
        LOGGER.trace(
            ...
            threadId, topElement.getName(), startLine, startStackDepth);
        ...
        while (stepping) {
            ...
            LOGGER.trace(
                "Current state: thread id: {}, top element: {}, line: {}, stack depth: {}",
                threadId, topElement.getName(), currentLine, currentStackDepth);
            ...
            switch (stepType) {
                case LINE:
                    ...
                    stepping = currentMethod.equals(startMethod)

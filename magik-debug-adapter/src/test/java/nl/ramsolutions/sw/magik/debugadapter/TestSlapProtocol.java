...
public class TestSlapProtocol implements ISlapProtocol {
    ...
    @Override
    public CompletableFuture<ISlapResponse> step(final long threadId, final StepType stepType, final int count)
            throws IOException {
        return null;
    }

    @Override
    public CompletableFuture<ISlapResponse> evaluate(final long threadId, final int level, final String expression)
            throws IOException {
        return null;
    }

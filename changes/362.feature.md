...
- `ProductDefNameDoesNotMatchDirectoryNameCheck`/`product-name-does-not-match-directory-name`
...
- `ModuleDefNameDoesNotMatchDirectoryName`/`module-name-does-not-match-directory-name`
